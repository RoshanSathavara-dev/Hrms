...
namespace Hrms_system.Migrations
{
    ...
    [Migration("20250414105457_AddCompanySettings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hrms_system.Models.BreakRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hrms_system.Models.CompanySettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<TimeSpan>("CompanyEndTime")
                        .HasColumnType("time");

                    b.Property<int>("CompanyId")
                        .HasColumnType("int");

                    b.Property<TimeSpan>("CompanyStartTime")
                        .HasColumnType("time");

                    b.Property<int>("MaxBreakDuration")
                        .HasColumnType("int");

                    b.Property<int>("MaxBreaksAllowed")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hrms_system.Models.CompanySettings", b =>
                {
                    b.HasOne("Hrms_system.Models.Company", "Company")
                        .WithOne("Settings")
                        .HasForeignKey("Hrms_system.Models.CompanySettings", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
